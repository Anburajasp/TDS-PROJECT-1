...
Original file is located at
    https://colab.research.google.com/drive/1vujGmQ_GXMqXikYNqRCF3Zd2VDwq9j9l
"""
...
def get_users_in_Sydney():
    ...
    while True:
        response = requests.get(f'{BASE_URL}/search/users',
                                headers=HEADERS,
                                params={'q': 'location:Sydney followers:>100', 'page': page})
        data = response.json()
...
# Create README.md with the specified bullet points
readme_content = """
